...
const WeatherDetails = ({icon, temp, city, country, lat, log, humidity, wind}) => {
  ...
  <>
  <div className="image">
    <img src={icon} alt="Image" style={{height :"150px"}} />
  </div>
  ...
  <div className="data-container">
    <div className="element">
      <img src={humidityIcon} alt="humidity" style={{height:"50px"}}
      className='icon' />
      <div className="data">
    ...
    <div className="element">
      <img src={windIcon} alt="wind" style={{height:"50px"}}
      className='icon' />
      <div className="data">
...
function App() {
  ...
  try{
    ...
    setError("An error occured while detching weather data.");
  }
  finally{
    setLoading(false);
      ...
      <div className="container">
        ...
        <WeatherDetails icon={icon} temp={temp} city={city} country={country}
         ...
         <p className='copyright'>
           Designed by <span>Hrithik jin</span>
         </p>
